...
export const formFields = [
    ...
    { name: 'BloodPressure', label: 'Presión Arterial (mm Hg)', step: '1', initialValue: '72' },
    { name: 'SkinThickness', label: 'Grosor del Pliegue Cutáneo (mm)', step: '1', initialValue: '23' },
...
export const validationSchema = Yup.object({
  ...
  BloodPressure: Yup.number().min(0, 'No puede ser negativo').required('Campo obligatorio'),
  SkinThickness: Yup.number().min(0, 'No puede ser negativo').required('Campo obligatorio'),
